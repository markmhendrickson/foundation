...
- Check `.cursor/rules/` for foundation rule symlinks (using original filenames)
- Check `.cursor/commands/` for foundation command symlinks (using original filenames)
