...
1. **Load required documents:**
   ...
   - `foundation/agent-instructions/cursor-commands/create_feature_unit.md` (command implementation, or `.cursor/commands/foundation_create_feature_unit.md` if symlinked)
