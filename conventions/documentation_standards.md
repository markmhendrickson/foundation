...
1. **Decompose by Topic**: Large documents MUST be decomposed into topic-specific documents:
...
3. **Use YAML Only When Required**:
   ...
   - YAML files MUST contain: metadata, summaries, success criteria, timelines
   - YAML files MUST NOT contain: detailed descriptions, comprehensive content, lengthy text
4. **Eliminate Redundancy**:
   - Each piece of information MUST exist in only one place
...
5. **Cross-Reference Documents**:
   - All documents MUST include a "Related Documents" section
   - Overview documents MUST list all related detailed documents
   - Detailed documents MUST reference back to overview documents
...
### 5.2 Directive Tone
Documentation MUST use clear, directive language:
