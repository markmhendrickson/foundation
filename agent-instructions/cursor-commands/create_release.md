...
This command implements the Release workflow from `foundation/development/release_workflow.md`.
...
**Note:** This is a foundation command. If installed, it will be available in `.cursor/commands/` via symlink.
...
**Agent: Prompt user for execution strategy:**
...
- **Primary workflow:** `foundation/development/release_workflow.md`
